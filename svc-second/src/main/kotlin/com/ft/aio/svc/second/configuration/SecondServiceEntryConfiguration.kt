 ...
 */
package com.ft.aio.svc.second.configuration
...
@ComponentScans(
    ...
    ComponentScan(basePackages = ["com.ft.aio.svc.second"]),
)
@PropertySource(factory = YamlPropertySourceFactory::class, value = ["classpath:svc-second-config.yml"])
class SecondServiceEntryConfiguration {
}