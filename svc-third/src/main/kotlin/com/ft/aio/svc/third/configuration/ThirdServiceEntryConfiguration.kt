 ...
 */
package com.ft.aio.svc.third.configuration
...
@ComponentScans(
    ...
    ComponentScan(basePackages = ["com.ft.aio.svc.third"]),
)
@PropertySource(factory = YamlPropertySourceFactory::class, value = ["classpath:svc-third-config.yml"])
class ThirdServiceEntryConfiguration {
}